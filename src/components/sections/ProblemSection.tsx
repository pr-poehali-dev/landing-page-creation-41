      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-12">
          {[
            ...
            <Card key={idx} className="p-4 md:p-6 border-2 border-[#C89A5A]/30 hover:border-[#F7BA72]/70 transition-all problem-card bg-[#111722]/70 backdrop-blur-sm hover:shadow-[0_0_20px_rgba(247,186,114,0.15)]">
